    ...
    USE [DBAdmin] -- Specify the database in which the objects will be created.
    ...
    @DirectoryStructure nvarchar(max) = '{BackupType}_{Partial}_{CopyOnly}{DirectorySeparator}{ServerName}${InstanceName}{DirectorySeparator}{DatabaseName}',
    @AvailabilityGroupDirectoryStructure nvarchar(max) = '{BackupType}_{Partial}_{CopyOnly}{DirectorySeparator}{ClusterName}${AvailabilityGroupName}{DirectorySeparator}{DatabaseName}',
